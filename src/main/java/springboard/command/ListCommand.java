...
/* 
 	BbsCommandImpl를 구현하였으므로 execute()메소드는 반드시
 	오버라이딩 해야한다. 또한 해당 객체는 부모타입인 BbsCommandImpl로
	참조할 수 있다.
*/

/*
  	Service역할의 클래스임을 명시함
...
public class ListCommand implements BbsCommandImpl {
	...
	public void execute(Model model) {
		...
		/*
		 	컨트롤러에서 넘겨준 파라미터는 asMap() 메소드를 통해 Map컬렉션으로
		 	변환한다. 그리고 request객체를 형변환하여 가져온다.
		 */
		...
		// 리스트에 출력할 게시물의 시작/종료 구간 (select절의 between에 사용)
